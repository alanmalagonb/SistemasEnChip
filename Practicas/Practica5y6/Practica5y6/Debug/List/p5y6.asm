...
;CodeVisionAVR C Compiler V3.47 Evaluation
...
_0x3:
; 0000 008B {
; 0000 008C //Inicializar valores del botón actual
; 0000 008D if(boton == 0){
	SBIC 0x10,0
	RJMP _0x6
; 0000 008E botona = 0;
	CLT
...
; 0000 0092 }
; 0000 0093 
; 0000 0094 //Activación por flancos y eliminación de rebotes
; 0000 0095 if((botonp == 1) && (botona == 0)){   //Hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
_0x9:
	RJMP _0x8
_0xA:
; 0000 0096 var++;  //Se incrementa la variable
	INC  R5
; 0000 0097 if(var == 10){
	LDI  R30,LOW(10)
	CP   R30,R5
...
; 0000 0098 var = 0;
	CLR  R5
; 0000 0099 }
; 0000 009A delay_ms(40);       //Se coloca retardo de 40ms para eliminar rebotes
_0xB:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 009B }
; 0000 009C if((botonp == 0) && (botona == 1)){   //Hubo cambio de flanco de 0 a 1
_0x8:
	SBRC R2,0
	RJMP _0xD
	SBRC R2,1
...
; 0000 009E }
; 0000 009F 
; 0000 00A0 PORTB = tabla7segmentos[var];
_0xC:
	MOV  R30,R5
	LDI  R31,0

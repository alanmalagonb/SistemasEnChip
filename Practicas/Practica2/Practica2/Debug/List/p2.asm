...
; 0000 001F int tiempo = 750; //tiempo del delay
; 0000 0020 
...
; 0000 0085 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0086 
; 0000 0087 PORTB = 0x00;           //Inicialización Puerto B
	OUT  0x18,R30
; 0000 0088 PORTD = 0xFF;           //Inicialización Puerto D
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0089 
; 0000 008A while (1)
...
; 0000 008D delay_ms(tiempo);    //Delay de 500 ms para visualizar información
	MOVW R26,R16
	RCALL _delay_ms
; 0000 008E PORTB ++;         //Incremento Puerto B
	IN   R30,0x18
	SUBI R30,-LOW(1)
	OUT  0x18,R30
; 0000 008F PORTD --;         //Decremento Puerto D
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
; 0000 0090 }

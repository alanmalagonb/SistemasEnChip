...
; 0000 0105 case 0:
	SBIW R30,0
	BRNE _0x25
; 0000 0106 if (cambio_caso == 4) cambiar_modo();
	LDI  R30,LOW(4)
	CP   R30,R10
	BRNE _0x26
	RCALL _cambiar_modo
...
_0x25:
	RCALL SUBOPT_0x1
	BRNE _0x27
; 0000 010A if (cambio_caso == 50) cambiar_modo();
	LDI  R30,LOW(50)
	CP   R30,R10
	BRNE _0x28
	RCALL _cambiar_modo
...
_0x27:
	RCALL SUBOPT_0x3
	BRNE _0x29
; 0000 010E if (cambio_caso == 50) cambiar_modo();
	LDI  R30,LOW(50)
	CP   R30,R10
	BRNE _0x2A
	RCALL _cambiar_modo
...
_0x29:
	...
	CPC  R31,R26
	BRNE _0x2D
; 0000 0112 if (cambio_caso == 5) cambiar_modo();
	LDI  R30,LOW(5)
	CP   R30,R10
	BRNE _0x2C
	RCALL _cambiar_modo
...
; 0000 0115 default:
_0x2D:
; 0000 0116 if (puede_cambiar) cambiar_modo();
	SBRC R2,0
	RCALL _cambiar_modo
; 0000 0117 }
_0x24:
; 0000 0118 
; 0000 0119 PORTC = columnas;
	OUT  0x15,R4
; 0000 011A PORTD = filas;
	OUT  0x12,R7

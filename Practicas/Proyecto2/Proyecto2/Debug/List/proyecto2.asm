...
; 0000 0040 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0041 
...
; 0000 0073 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0074 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
_0x7:
	RJMP _0x6
_0x8:
; 0000 00A5 for (i=0; i<size; i++) inst[i] = 0;
	LDI  R30,LOW(0)
	ST   Y,R30
_0xA:
	LD   R26,Y
	...
	RJMP _0xA
_0xB:
; 0000 00A6 write_index = 0;
	CLR  R4
; 0000 00A7 read_index = 0;
	CLR  R5
; 0000 00A8 mode = 0;
	RCALL SUBOPT_0x1
; 0000 00A9 delay_ms(20);
; 0000 00AA }
; 0000 00AB 
; 0000 00AC if (p_pau == 1 && a_pau == 0) {
_0x6:
	SBRS R3,4
	RJMP _0xD
	SBRS R2,5
...
; 0000 00AD mode = 0;
	RCALL SUBOPT_0x1
; 0000 00AE delay_ms(20);
; 0000 00AF }
; 0000 00B0 
; 0000 00B1 if (p_go == 1 && a_go == 0) {
_0xC:
	SBRS R3,5
	RJMP _0x10
	SBRS R2,6
...
; 0000 00B2 mode = 1;
	SET
	BLD  R3,6
; 0000 00B3 delay_ms(20);
	RCALL SUBOPT_0x2
; 0000 00B4 }
; 0000 00B5 
; 0000 00B6 if (p_clr == 0 && a_clr == 1) delay_ms(20);
_0xF:
	SBRC R3,3
	RJMP _0x13
	SBRC R2,4
...
_0x14:
	RCALL SUBOPT_0x2
; 0000 00B7 if (p_pau == 0 && a_pau == 1) delay_ms(20);
_0x12:
	SBRC R3,4
	RJMP _0x16
	SBRC R2,5
...
_0x17:
	RCALL SUBOPT_0x2
; 0000 00B8 if (p_go == 0 && a_go == 1) delay_ms(20);
_0x15:
	SBRC R3,5
	RJMP _0x19
	SBRC R2,6
...
_0x1A:
	RCALL SUBOPT_0x2
; 0000 00B9 
; 0000 00BA //GRABADO Y LECTURA DE INSTRUCCIONES
; 0000 00BB if (mode == 0 && write_index < size) {
_0x18:
	SBRC R3,6
	RJMP _0x1C
	MOV  R26,R4
...
_0x28:
	RJMP _0x27
_0x29:
; 0000 00D4 inst[write_index] = 4;
	RCALL SUBOPT_0x3
	LDI  R26,LOW(4)
	RCALL SUBOPT_0x4
; 0000 00D5 write_index++;
; 0000 00D6 delay_ms(20);
; 0000 00D7 }
; 0000 00D8 
; 0000 00D9 if (p_izq == 0 && a_izq == 1) delay_ms(20);
_0x27:
	SBRC R2,7
	RJMP _0x2B
	SBRC R2,0
...
_0x2C:
	RCALL SUBOPT_0x2
; 0000 00DA if (p_der == 0 && a_der == 1) delay_ms(20);
_0x2A:
	SBRC R3,0
	RJMP _0x2E
	SBRC R2,1
...
_0x2F:
	RCALL SUBOPT_0x2
; 0000 00DB if (p_arr == 0 && a_arr == 1) delay_ms(20);
_0x2D:
	SBRC R3,1
	RJMP _0x31
	SBRC R2,2
...
_0x32:
	RCALL SUBOPT_0x2
; 0000 00DC if (p_aba == 0 && a_aba == 1) delay_ms(20);
_0x30:
	SBRC R3,2
	RJMP _0x34
	SBRC R2,3
...
_0x35:
	RCALL SUBOPT_0x2
; 0000 00DD }else if (mode == 1 && read_index < size) {
_0x33:
	RJMP _0x36
_0x1B:
	SBRS R3,6
...
_0x38:
	RJMP _0x37
_0x39:
; 0000 00DE current = inst[read_index];
	MOV  R30,R5
	RCALL SUBOPT_0x0
	LD   R30,Z
	STD  Y+1,R30
; 0000 00DF read_index++;
	INC  R5
; 0000 00E0 
; 0000 00E1 switch(current){
	LDI  R31,0
; 0000 00E2 case 1:
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	BRNE _0x3D
; 0000 00E3 PORTA = DERECHA;
	LDI  R30,LOW(4)
	RJMP _0x42
; 0000 00E4 delay_ms(50);
; 0000 00E5 PORTA = 0x00;
; 0000 00E6 break;
; 0000 00E7 
; 0000 00E8 case 2:
_0x3D:
	...
	CPC  R31,R26
	BRNE _0x3E
; 0000 00E9 PORTA = IZQUIERDA;
	LDI  R30,LOW(1)
	RJMP _0x42
; 0000 00EA delay_ms(50);
; 0000 00EB PORTA = 0x00;
; 0000 00EC break;
; 0000 00ED 
; 0000 00EE case 3:
_0x3E:
	...
	CPC  R31,R26
	BRNE _0x3F
; 0000 00EF PORTA = ARRIBA;
	LDI  R30,LOW(5)
	RJMP _0x42
; 0000 00F0 delay_ms(50);
; 0000 00F1 PORTA = 0x00;
; 0000 00F2 break;
; 0000 00F3 
; 0000 00F4 case 4:
_0x3F:
...
_0x3C:
; 0000 00FA }
; 0000 00FB p_izq = a_izq;
_0x37:
_0x36:
	BST  R2,0
	BLD  R2,7
; 0000 00FC p_der = a_der;
	BST  R2,1
	BLD  R3,0
; 0000 00FD p_arr = a_arr;
	BST  R2,2
	BLD  R3,1
; 0000 00FE p_aba = a_aba;
	BST  R2,3
	BLD  R3,2
; 0000 00FF p_clr = a_clr;
	BST  R2,4
	BLD  R3,3
; 0000 0100 p_pau = a_pau;
	BST  R2,5
	BLD  R3,4
; 0000 0101 p_go = a_go;
	BST  R2,6

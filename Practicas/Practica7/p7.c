...
while (1)
      ...
      if(boton == 1){       //Se cambia a 1 para invertir el botón
        botona = 0;
      }
      else{
        botona = 1;
      ...
      if((botonp == 1) && (botona == 0)){   //Hubo cambio de flanco de 1 a 0
        var++;              //Incremento de la variable del display 1
        delay_ms(40);       //Se coloca retardo de 40ms para eliminar rebotes
        
        if(var==10){
            var2++;         //Incremento de la variable del display 2
            var = 0;        //Reinicio de la variable del display 1
        }
        if(var2==10){
            var2 = 0;       //Reinicio de la variable del display 2
        }
      }

...
; 0000 0029 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 003D PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 003E 
...
_0x3:
; 0000 008D {
; 0000 008E //Inicializar valores del botón actual
; 0000 008F if(boton == 1){       //Se cambia a 1 para invertir el botón
	SBIS 0x10,0
	RJMP _0x6
; 0000 0090 botona = 0;
	CLT
...
_0x11:
	BLD  R2,1
; 0000 0094 }
; 0000 0095 //Activación por flancos y eliminación de rebotes
; 0000 0096 if((botonp == 1) && (botona == 0)){   //Hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
_0x9:
	RJMP _0x8
_0xA:
; 0000 0097 var++;              //Incremento de la variable del display 1
	INC  R5
; 0000 0098 delay_ms(40);       //Se coloca retardo de 40ms para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0099 
; 0000 009A if(var==10){
	...
	CP   R30,R5
	BRNE _0xB
; 0000 009B var2++;         //Incremento de la variable del display 2
	INC  R4
; 0000 009C var = 0;        //Reinicio de la variable del display 1
	CLR  R5
; 0000 009D }
; 0000 009E if(var2==10){
_0xB:
	LDI  R30,LOW(10)
	CP   R30,R4
	BRNE _0xC
; 0000 009F var2 = 0;       //Reinicio de la variable del display 2
	CLR  R4
; 0000 00A0 }
; 0000 00A1 }
_0xC:
; 0000 00A2 if((botonp == 0) && (botona == 1)){   //Hubo cambio de flanco de 0 a 1
_0x8:
	SBRC R2,0
	RJMP _0xE
	SBRC R2,1
...
; 0000 00A4 }
; 0000 00A5 
; 0000 00A6 PORTC = tabla7segmentos[var];
_0xD:
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x15,R0
; 0000 00A7 PORTA = tabla7segmentos[var2];
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x1B,R0

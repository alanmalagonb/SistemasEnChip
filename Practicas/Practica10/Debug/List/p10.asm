...
; 0000 0030 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0031 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0032 // State: Bit7=T Bit6=T Bit5=P Bit4=P Bit3=P Bit2=0 Bit1=0 Bit0=0
; 0000 0033 PORTC=(0<<PORTC7) | (0<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(56)
	OUT  0x15,R30
; 0000 0034 
...
; 0000 008A tecla = 0;
	CLR  R5
; 0000 008B 
; 0000 008C //C0 A C2 son de salida y son para probar las 3 columnas
; 0000 008D //Se prueba la primera columna se envía 110
; 0000 008E PORTC=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 008F 
; 0000 0090 //C3, C4 y C5 son las entradas del teclado
; 0000 0091 //Por eso se enmascaran con 00111000
; 0000 0092 lectura=PINC&0b00111000;
; 0000 0093 
; 0000 0094 if (lectura==0b00110000){
	BRNE _0x6
; 0000 0095 tecla=7;
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 0096 }
; 0000 0097 if (lectura==0b00101000){
_0x6:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x7
; 0000 0098 tecla=8;
	...
	MOV  R5,R30
; 0000 0099 }
; 0000 009A if (lectura==0b00011000){
_0x7:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x8
...
; 0000 009C }
; 0000 009D 
; 0000 009E //Se prueba segunda columna se envía 101
; 0000 009F PORTC=0b00111101;
_0x8:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 00A0 
...
; 0000 00A4 
; 0000 00A5 if (lectura==0b00110000){
	BRNE _0x9
; 0000 00A6 tecla=4;
	LDI  R30,LOW(4)
	MOV  R5,R30
...
; 0000 00A9 tecla=5;
	...
	MOV  R5,R30
; 0000 00AA }
; 0000 00AB if (lectura==0b00011000){
_0xA:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xB
...
; 0000 00AD }
; 0000 00AE 
; 0000 00AF //Se prueba tercera columna se envía 011
; 0000 00B0 PORTC=0b00111011;
_0xB:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 00B1 
; 0000 00B2 //C3, C4 y C5 son las entradas del teclado
; 0000 00B3 //Por eso se enmascaran con 00111000
; 0000 00B4 lectura=PINC&0b00111000;
; 0000 00B5 
; 0000 00B6 if (lectura==0b00110000){
	BRNE _0xC
; 0000 00B7 tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00B8 }
; 0000 00B9 if (lectura==0b00101000){
_0xC:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xD
; 0000 00BA tecla=2;
	...
	MOV  R5,R30
; 0000 00BB }
; 0000 00BC if (lectura==0b00011000){
_0xD:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xE
...
; 0000 00BE }
; 0000 00BF 
; 0000 00C0 PORTB=tabla7segmentos [tecla];
_0xE:
	MOV  R30,R5
	LDI  R31,0

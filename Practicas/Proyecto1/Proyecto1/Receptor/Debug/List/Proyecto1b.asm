...
_0x3:
; 0000 0089 {
; 0000 008A contador = 0;
	CLR  R4
	CLR  R5
; 0000 008B 
; 0000 008C for (i = 0; i < 500; i++) {
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(500)
	...
	CPC  R7,R31
	BRGE _0x8
; 0000 008D if (ENTRADA == 1) contador++;
	SBIS 0x16,0
	RJMP _0x9
	MOVW R30,R4
	ADIW R30,1
...
_0x8:
; 0000 0090 
; 0000 0091 if(contador >= 15 && contador <= 35) {
	LDI  R30,LOW(15)
	LDI  R31,HIGH(15)
	RCALL SUBOPT_0x0
	BRLT _0xB
...
; 0000 0095 PORTA.3 = 0;
	CBI  0x1B,3
; 0000 0096 }
; 0000 0097 else if(contador >= 40 && contador <= 60) {
	RJMP _0x15
_0xA:
	LDI  R30,LOW(40)
	LDI  R31,HIGH(40)
...
; 0000 009B PORTA.3 = 0;
	CBI  0x1B,3
; 0000 009C }
; 0000 009D else if(contador >= 65 && contador <= 85) {
	RJMP _0x21
_0x16:
	LDI  R30,LOW(65)
	LDI  R31,HIGH(65)
...
; 0000 00A1 PORTA.3 = 0;
	CBI  0x1B,3
; 0000 00A2 }
; 0000 00A3 else if(contador >= 90 && contador <= 110) {
	RJMP _0x2D
_0x22:
	LDI  R30,LOW(90)
	LDI  R31,HIGH(90)

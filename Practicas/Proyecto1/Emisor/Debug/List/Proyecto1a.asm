...
; 0000 002D DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(0)
	OUT  0x17,R30
; 0000 002E // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 002F PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0030 
...
; 0000 008C if(IZQ == 0) {
	SBIC 0x16,0
	RJMP _0x6
; 0000 008D PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 008E delay_ms(25);
	LDI  R26,LOW(25)
	RCALL SUBOPT_0x2
; 0000 008F PORTA = 0x00;
; 0000 0090 delay_ms(475);
	LDI  R26,LOW(475)
	LDI  R27,HIGH(475)
	RJMP _0xE
; 0000 0091 } else if(DER == 0) {
_0x6:
	SBIC 0x16,1
	RJMP _0x8
; 0000 0092 PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 0093 delay_ms(50);
	LDI  R26,LOW(50)
	RCALL SUBOPT_0x2
; 0000 0094 PORTA = 0x00;
; 0000 0095 delay_ms(450);
	LDI  R26,LOW(450)
	LDI  R27,HIGH(450)
	RJMP _0xE
; 0000 0096 } else if(ARRIBA == 0) {
_0x8:
	SBIC 0x16,2
	RJMP _0xA
; 0000 0097 PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 0098 delay_ms(75);
	LDI  R26,LOW(75)
	RCALL SUBOPT_0x2
; 0000 0099 PORTA = 0x00;
; 0000 009A delay_ms(425);
	LDI  R26,LOW(425)
	LDI  R27,HIGH(425)
	RJMP _0xE
; 0000 009B } else if(ABAJO == 0) {
_0xA:
	SBIC 0x16,3
	RJMP _0xC
; 0000 009C PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 009D delay_ms(100);
	LDI  R26,LOW(100)
	RCALL SUBOPT_0x2
; 0000 009E PORTA = 0x00;
; 0000 009F delay_ms(400);
	LDI  R26,LOW(400)
	LDI  R27,HIGH(400)
_0xE:
	RCALL _delay_ms

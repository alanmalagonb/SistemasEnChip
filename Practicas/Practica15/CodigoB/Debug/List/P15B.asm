...
; 0000 003E DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 0091 // ADC High Speed Mode: Off
; 0000 0092 // ADC Auto Trigger Source: ADC Stopped
; 0000 0093 // Only the 8 most significant bits of
; 0000 0094 // the AD conversion result are used
; 0000 0095 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 0096 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
; 0000 0097 SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 0098 
...
; 0000 00A3 valor = read_adc(0);
	...
	STS  _valor+2,R22
	STS  _valor+3,R23
; 0000 00A4 intensidad = 300 * valor / 255;
	__GETD2N 0x12C
	RCALL __MULD12U
	MOVW R26,R30
	MOVW R24,R22
	...
	RCALL __DIVD21U
	STS  _intensidad,R30
	STS  _intensidad+1,R31
	STS  _intensidad+2,R22
	STS  _intensidad+3,R23
; 0000 00A5 
; 0000 00A6 delay_ms(5);
	RCALL SUBOPT_0x0
; 0000 00A7 PORTB = ~mem[intensidad/100];
	RCALL SUBOPT_0x1
; 0000 00A8 PORTC = 0x01;
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 00A9 
; 0000 00AA delay_ms(5);
	RCALL SUBOPT_0x0
; 0000 00AB PORTB = ~mem[intensidad%100/10];
	RCALL __MODD21U
	MOVW R26,R30
	MOVW R24,R22
	RCALL SUBOPT_0x2
	RCALL SUBOPT_0x1
; 0000 00AC PORTC = 0x02;
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 00AD 
; 0000 00AE delay_ms(5);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 00AF PORTB = ~mem[intensidad%10];
	LDS  R26,_intensidad
	LDS  R27,_intensidad+1
	LDS  R24,_intensidad+2
	LDS  R25,_intensidad+3
	RCALL SUBOPT_0x2
	RCALL __MODD21U
	SUBI R30,LOW(-_mem*2)

...
; 0000 00A3 valor = read_adc(0);
	...
	RCALL _read_adc
	MOV  R5,R30
; 0000 00A4 intensidad = 50 * valor / 255;
	LDI  R26,LOW(50)
	MUL  R30,R26
	MOVW R30,R0
	MOVW R26,R30
	...
	MOV  R4,R30
; 0000 00A5 
; 0000 00A6 delay_ms(7);
	RCALL SUBOPT_0x0
; 0000 00A7 PORTB = ~mem[intensidad/10];
	LDI  R27,0
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __DIVW21
	RCALL SUBOPT_0x1
; 0000 00A8 PORTC = 0x02;
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 00A9 
; 0000 00AA delay_ms(7);
	RCALL SUBOPT_0x0
; 0000 00AB PORTB = ~mem[intensidad%10];
	CLR  R27
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __MODW21

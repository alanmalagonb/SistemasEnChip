...
; 0000 001D indice++;
	INC  R5
; 0000 001E if (indice == 10) indice = 0;
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x3
	CLR  R5
...
; .FSTART _ext_int1_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0024 if (indice == 0) indice = 9;
	TST  R5
	BRNE _0x4
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0025 else indice--;
	RJMP _0x5
_0x4:
	DEC  R5
; 0000 0026 }
...
; 0000 0038 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 0044 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0045 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0046 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0047 
...
; 0000 006D ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 006E TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0078 // INT1: On
; 0000 0079 // INT1 Mode: Low level
; 0000 007A // INT2: Off
; 0000 007B GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 007C MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(3)
	OUT  0x35,R30
...
; 0000 0097 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0098 
; 0000 0099 // Globally enable interrupts
; 0000 009A #asm("sei")
	SEI
; 0000 009B 
; 0000 009C while (1)

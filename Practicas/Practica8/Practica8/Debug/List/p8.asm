...
; 0000 002B DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 003D DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 003E // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
...
_0x3:
; 0000 008F {
; 0000 0090 //Condiciones de los botones start, stop y reset
; 0000 0091 if(start == 0){  //No se inicia el cronómetro
	SBIC 0x10,2
	RJMP _0x6
; 0000 0092 botona = 0;
	CLT
	RJMP _0x1E
; 0000 0093 }
; 0000 0094 else if(stop == 0){ //No se detiene el cronómetro
_0x6:
	SBIC 0x10,1
	RJMP _0x8
; 0000 0095 botona = 1;
...
; 0000 0096 conteo = 0;
	...
	BLD  R2,2
; 0000 0097 }
; 0000 0098 else if(reset == 0){    //No se reinicia el cronómetro
	RJMP _0x9
_0x8:
	SBIC 0x10,0
	RJMP _0xA
...
_0x9:
; 0000 009F 
; 0000 00A0 //Funcionamiento del cronómetro
; 0000 00A1 if(botona == 0){    //START
	SBRC R2,0
	RJMP _0xC
; 0000 00A2 if(milesimas == 9){
	LDI  R30,LOW(9)
	CP   R30,R7
	BRNE _0xD
; 0000 00A3 if(unidades == 9){
	CP   R30,R4
	BRNE _0xE
; 0000 00A4 decenas++;
	INC  R5
; 0000 00A5 unidades = 0;
	CLR  R4
; 0000 00A6 PORTA.7 = 1; //Punto del display de unidades
	SBI  0x1B,7
; 0000 00A7 if(decenas == 6 && unidades == 0){
	LDI  R30,LOW(6)
	CP   R30,R5
	BRNE _0x12
	TST  R4
...
; 0000 00AF }
_0x14:
; 0000 00B0 milesimas = 0;
	CLR  R7
; 0000 00B1 delay_ms(100); //Visualización de la información en los displays
	RJMP _0x1F
; 0000 00B2 }
; 0000 00B3 else{
_0xD:
...
; 0000 00B8 else{       //STOP
	RJMP _0x18
_0xC:
; 0000 00B9 if(conteo == 0){
	SBRC R2,2
	RJMP _0x19
; 0000 00BA unidades = unidades;
; 0000 00BB decenas = decenas;
; 0000 00BC milesimas = milesimas;
; 0000 00BD PORTA.7 = 1;
	SBI  0x1B,7
; 0000 00BE }
; 0000 00BF else{   //RESET
	RJMP _0x1C
_0x19:
; 0000 00C0 decenas = 0;
	CLR  R5
; 0000 00C1 unidades = 0;
	CLR  R4
; 0000 00C2 milesimas = 0;
	CLR  R7
; 0000 00C3 }
_0x1C:
; 0000 00C4 }
_0x18:
; 0000 00C5 PORTA = tabla7segmentos[unidades];
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 00C6 PORTB = tabla7segmentos[decenas];
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x18,R0
; 0000 00C7 PORTC = tabla7segmentos[milesimas];
	MOV  R30,R7
	RCALL SUBOPT_0x0
	OUT  0x15,R0
; 0000 00C8 botonp = botona;
	BST  R2,0
	BLD  R2,1
; 0000 00C9 }
	RJMP _0x3

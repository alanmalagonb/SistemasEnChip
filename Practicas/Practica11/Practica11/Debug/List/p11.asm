...
;CodeVisionAVR C Compiler V3.48a 
...
; 0000 0033 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 003B PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 003C 
...
; 0000 008E TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 008F 
; 0000 0090 if (datoaguardar>10){
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	CPI  R30,LOW(0xB)
	BRLO _0x3
; 0000 0091 datoaguardar=0;
	RCALL SUBOPT_0x0
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 0092 }
; 0000 0093 var=datoaguardar;
_0x3:
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	MOV  R5,R30
...
_0x4:
; 0000 0096 {
; 0000 0097 checa_boton();
	RCALL _checa_boton
; 0000 0098 PORTB=tabla7segmentos [var];
	MOV  R30,R5
	LDI  R31,0
	...
	LPM  R0,Z
	OUT  0x18,R0
; 0000 0099 if (boton_guarda==0) //Si se presiona el botón de guardar
	SBIC 0x13,1
	RJMP _0x7
; 0000 009A datoaguardar=var; //se grabara la eeprom con el valor de var
	MOV  R30,R5
	RCALL SUBOPT_0x0
	RCALL __EEPROMWRB
; 0000 009B };
...
; .FEND
;void checa_boton (void){
; 0000 009F void checa_boton (void){
_checa_boton:
; .FSTART _checa_boton
; 0000 00A0 if (boton==0)
	SBIC 0x13,0
	RJMP _0x9
; 0000 00A1 botona=0;
	CLT
...
_0x12:
	BLD  R2,1
; 0000 00A4 if ((botonp==1)&&(botona==0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xC
	SBRS R2,1
	RJMP _0xD
...
_0xD:
; 0000 00A5 {
; 0000 00A6 var++; //Se incrementa la variable
	INC  R5
; 0000 00A7 if (var>=10)
	LDI  R30,LOW(10)
	CP   R5,R30
...
_0xE:
	...
	RCALL _delay_ms
; 0000 00AA }
; 0000 00AB if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0xB:
	SBRC R2,0
	RJMP _0x10
	SBRC R2,1
...
_0x10:
	RJMP _0xF
_0x11:
; 0000 00AC delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00AD botonp=botona;
_0xF:
	BST  R2,1
	BLD  R2,0
; 0000 00AE }
